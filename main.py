...
def get_test_dataset(IMAGE_SIZE=256):
    test_dataset = TripletDataset(test_set,path=train_data_path,train=False,transform=transforms.Compose([transforms.ToTensor(),transforms.Resize((IMAGE_SIZE,IMAGE_SIZE))]))    
    return test_dataset
